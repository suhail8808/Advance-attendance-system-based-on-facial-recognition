...
def getDateFromUser():
    ...
    print("date Format is:", "DD-MM-YYYY/HH:MM:SS")
...
def scan_face():
    ...
    today_date_and_time = getDateFromUser()
...
try:
    f = PyFingerprint(Conf.port, 57600, 0xFFFFFFFF, 0x00000000)
...
try:
    ...
    if ( positionNumber == -1 ):
        ...
        scan_face()
        # Open a subprocess, redirecting both stdin and stdout
